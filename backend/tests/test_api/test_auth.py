...
class TestRegister:
    def test_register_success(self, test_client):
        response = test_client.post(
            "/api/auth/register",
            json={"phone": "13800000011", "password": "test123456"},
        )
    ...
    def test_register_duplicate_phone(self, test_client):
        ...
        test_client.post(
            "/api/auth/register",
            json={"phone": "13800000012", "password": "test123456"},
        )
        # Duplicate
        response = test_client.post(
            "/api/auth/register",
    ...
    def test_register_short_password(self, test_client):
        response = test_client.post(
            "/api/auth/register",
            json={"phone": "13800000013", "password": "12345"},
        )
...
class TestLogin:
    def test_login_success(self, test_client):
        ...
        test_client.post(
            "/api/auth/register",
            json={"phone": "13800000014", "password": "test123456"},
        )
        # Login
        response = test_client.post(
            "/api/auth/login",
            json={"account": "13800000014", "password": "test123456"},
        )
        assert response.status_code == 200
        data = response.json()
        assert "token" in data
    ...
    def test_login_wrong_password(self, test_client):
        test_client.post(
            "/api/auth/register",
            json={"phone": "13800000015", "password": "test123456"},
        )
        response = test_client.post(
            "/api/auth/login",
    ...
    def test_login_nonexistent_user(self, test_client):
        response = test_client.post(
            "/api/auth/login",
            json={"account": "13899999999", "password": "test123456"},
        )
        assert response.status_code == 401
