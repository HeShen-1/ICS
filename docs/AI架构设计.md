...
| 参数 | 值 | 说明 |
|------|-----|------|
| chunk_size | 按文档类型自适应 | FAQ=256, Policy=400, Tech=600, Default=600 |
...
- **FAQ 类文档（256）**：Q&A 对独立成块，精确匹配
- **政策类文档（400）**：1-2 个 section 一块，保留规则上下文
- **技术类文档（600）**：长段落需更大窗口保持语义完整
- **重叠率 15%**：同 section 相邻 chunk 共享 1 句上下文，避免跨 section 污染
