...
### 2.6 daily_question_count — 每日提问计数表
...
| documents | 100 | ~300B | 30KB |
| daily_question_count | 365000 | ~50B | 18MB |

> 预估基于：1000 用户，每用户 5 会话，每会话 10 轮对话。开发阶段数据量极小，无需分表分库。
